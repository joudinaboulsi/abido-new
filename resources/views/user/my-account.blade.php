    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 px-3 py-4 pb-1">
                <h3 class="ml-2"><a href="{{ route('home_path') }}" class="text-dark"><u>Home</u></a> / My Account
                </h3>
                            ...
                            <div class="col-lg-12 pt-3">
                                ...
                                @if ($addresses !== null)
                                    @foreach ($addresses as $a)
                                        <b>{{ $a->title }} <small>({{ $a->firstname }}
                                                {{ $a->lastname }})</small></b> <br>
                                        {{ $a->fullAddress }} | {{ $a->phone }} <br>
                                        <a
                                            href="{{ route('my_account_delete_user_address', $a->id) }}"><small>Delete</small></a><br><br>
                                    @endforeach
                                @endif
                                <hr>

                                <h5>
                                    <a href="#" data-toggle="modal" data-target="#addShippingAddress"> Add new
                                        address </a> <i class="float-right text-primary fas fa-home"></i>
                                    <hr>
                                    @if (session()->get('showPassord') == 1)
                                        <a href="" data-toggle="modal" data-target="#editPassword">Edit
                                            Password</a><i class="float-right text-primary fas fa-edit"></i>
                                        <hr>
                                    @endif

                                    <a href="{{ route('logout_path') }}"> Logout </a> <i
                                        class="float-right text-primary fas fa-sign-out-alt"></i>
                                </h5>
                                <hr>
                    ...
                    <div class="col-lg-8 px-4">
                        <div class="bg-white p-3">
                            ...
                            <div class="col-lg-12 pt-3">
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    @if ($order->status_id == 3)
                                                        <s><a href="" data-toggle="modal"
                                                                data-target="#orderDetails_{{ $order->id }}">#{{ $order->code }}</a></s>
                                                    @else
                                                        <a href="" data-toggle="modal"
                                                            data-target="#orderDetails_{{ $order->id }}">#{{ $order->code }}</a>
                                                    @endif
                                                </td>
                                                ...
                                                <td>{{ $order->total }} <small>{{ $order->currency }} </small> for
                                                    {{ count($order->items) }} items</td>
                                                <td>
                                                    <button class="float-right m-2 p-2 btn btn-secondary"
                                                        data-toggle="modal"
                                                        data-target="#orderDetails_{{ $order->id }}">View</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <br>
                                <a href="{{ route('shop_path') }}"><button class="m-2 p-2 btn btn-primary">Continue
                                        shopping</button></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($o->items as $orderItem)
                                                <tr>
                                                    <td>
                                                        ...
                                                        @elseif($language == 'AR')
                                                            {{ $orderItem->product_title_ar }}
                                                        @elseif($language == 'FR')
                                                            {{ $orderItem->product_title_fr }}
                                                        @endif
                                                    ...
                                                    <td>{{ $orderItem->price * $o->currency_rate }}
                                                        <small>{{ $o->currency }}</small></td>
                                                    <td>{{ $orderItem->quantity }}</td>
                                                    <td>{{ $orderItem->quantity * $orderItem->price * $o->currency_rate }}
                                                        <small>{{ $o->currency }}</small></td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                                <td>Subtotal</td>
                                                <td colspan="3">{{ $o->itemsTotalPrice * $o->currency_rate }}
                                                    <small>{{ $o->currency }}</small></td>
                                            </tr>
                                            <tr>
                                                <td>Discount</td>
                                                <td colspan="3">{{ $o->discount_value }} <small>
                                                        {{ $o->currency }} @if ($o->discount_code != null)
                                                            ({{ $o->discount_code }})
                                                        @endif
                                                    </small></td>
                                            </tr>
                                            <tr>
                                                <td>Tax</td>
                                                <td colspan="3">{{ $o->taxAmount }}
                                                    <small>{{ $o->currency }}</small></td>
                                            </tr>
                                            <tr>
                                                <td>Shipping Fees</td>
                                                <td colspan="3">{{ $o->shipping_fees }}
                                                    <small>{{ $o->currency }}</small></td>
                                            </tr>
                                            <tr>
                                                <td><b>Total</b></td>
                                                <td colspan="3">{{ $o->total }}
                                                    <small>{{ $o->currency }}</small></td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <form method="POST" action="{{ route('my_account_add_user_address') }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="Title" class="form-control form-group checkout_inputs"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="firstname"
                                    maxlength="{{ app('settings')->environment->address_firstname_max_char }}"
                                    placeholder="First name" class="form-control form-group checkout_inputs"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="lastname"
                                    ...
                                    placeholder="Last name" class="form-control form-group checkout_inputs"
                        ...
                        @if (app('settings')->environment->address_has_apartment == 1)
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input class="form-control form-group checkout_inputs" type="text"
                                        name="apartment"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <label>Address</label>
                                <input class="form-control form-group checkout_inputs" type="text" name="address"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <label>City</label>
                                <input class="form-control form-group checkout_inputs" type="text" name="city"
                            ...
                            <div class="col-lg-6">
                                ...
                                <span id="province_shipping">
                                    ...
                                    <input type="text" name="province" placeholder="province"
                                        class="form-control checkout_inputs" required>
                        ...
                        @if ($GoogleMaps == 1)
                            <div class="row">
                                <div class="col-lg-6">
                                    <div id="map" style="height:400px; width:760px;" class="my-3">
                                        <script async defer
                                            src="https://maps.googleapis.com/maps/api/js?key={{ app('settings')->environment->keyMapFrontend }}&callback=initMap"
                                            type="text/javascript"></script>
                                    </div>
                                    <input type="hidden" name="long"
                                        value="{{ app('settings')->environment->latitude }}" id="long" />
                                    <input name="lat" type="hidden"
                                        value="{{ app('settings')->environment->longitude }}" id="lat" />
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="password" name="old_password" maxlength="" placeholder="Old password"
                                    class="form-control form-group checkout_inputs" value="{{ old('old_password') }}"
                                    required />
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="password" name="new_password" maxlength="" placeholder="New password"
                                    class="form-control form-group checkout_inputs" value="{{ old('new_password') }}"
                                    required />
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="password" name="confirm_password" maxlength=""
                                    placeholder="Confirm password" class="form-control form-group checkout_inputs"
