...
<body>
        ...
        <div class="d-block d-lg-none">
            ...
            <div class="row d-block d-lg-none shopping_cart_order_summary">
                ...
                <div style="font-size: 18px;">
                    <b>Total: </b>
                    <b class="float-right">
                       @if(isset($checkoutData))  {{$checkoutData->subTotal * app('currency')[2]}}
                        @else 0
                        @endif <small>{{ app('currency')[0] }} (incl.
                            VAT)</small></b>
                </div>
   ...
   -->
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-8 p-4 pb-0">
                            ...
                            <div class="cart_product_list">
                                @if(isset($checkoutData))
                                @include('checkout.partials.shopping-cart-product-list')     
                                @include('checkout.partials.shopping-cart-box-list')
                                @endif
    ...
    <script type="text/javascript">
        ...
        function removeBoxItem(item_id,box_id) {
            $.ajax({
                url: "/remove-box-item",
                method: "POST",
                data: {
        ...
        function editOrderItemBox(id)
        {
         qty = $("#order_item_box"+id).val();
            $.ajax({
                url: "/edit-cart-qty-box",
                method: "POST",
                data: {
                    variant_id:id,
                    qty: qty,
