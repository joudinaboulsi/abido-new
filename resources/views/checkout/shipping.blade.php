            ...
            <div class="col-lg-8 p-4 pb-0">
                ...
                <form method="POST" action="{{ route('update_shipping_rate') }}">
                    ...
                    <div>
                        ...
                        <input type='hidden' value="{{ app('currency')[1] }}" name="currency_id">
                        <input type='hidden' value="{{ app('currency')[2] }}" name="currency_rate">
                        <div class="border px-2 py-1">
                            <div>
                                @if (!empty($shippingRates->tag_freeshipping))
                                                ...
                                                @foreach ($shippingRates->listShippingRate as $rates)
                                                    <tr @if ($counter != 0) class="border-top" @endif>
                                                        ...
                                                        <td class="shipping_rate_value">
                                                            {{ $rates->price * app('currency')[2] }}<small>{{ app('currency')[0] }}</small>
                                                        </td>
                                                    </tr>
                                                    <?php $counter++; ?>
                                                @endforeach
