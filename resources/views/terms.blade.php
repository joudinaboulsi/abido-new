                ...
                <div class="col-lg-12">
                    ...
                    @foreach ($data->sub_pages as $sub_page)
                        <article class="post-single">
                            @if ($language == 'ENG')
                                <h2 class="title custom-primary">{{ $sub_page->components->section_title->value }}</h2>
                            @elseif($sub_page->components->section_title_ar->value != null)
                                <h2 class="titl custom-primary" style="text-align:right">
                            ...
                            <div class="post-content">
                                <div class="recipe-ingredients">
                                    ...
                                    @elseif ($sub_page->components->subtitle_ar->value != null)
                                        <h4 class="custom-primary" style="text-align:right">
                                            {{ $sub_page->components->subtitle_ar->value }}</h4>
                                    @endif
                                    @if ($language == 'ENG')
                                        <p>
